...
const ProductCard = () => {
    return (
        <div className="bg-white rounded-md shadow-md lg:shadow-lg border border-transparent hover:border-[#427743] hover:border-opacity-20 overflow-hidden transition-shadow relative group h-fit">
            ...
            <div className="card-body space-y-1">
                ...
                <button className='kbm-bg-secondary flex items-center gap-1 py-2 px-5 w-full justify-center kbm-white rounded-md uppercase' type="button">
